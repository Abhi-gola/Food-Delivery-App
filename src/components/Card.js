                    ...
                    <div className="card-body">
                        ...
                        <div className='containers w-100'>
                            <select className='m-2 h-100 rounded bg-success' onChange={(e)=> setQty(e.target.value)}>
                                {/* <select className='m-2 h-100 rounded' style={{ backgroundColor: 'orange' }}> */}
                            ...
                            <select className='m-2 h-100 rounded bg-primary' ref={priceRef} onChange={(e)=> setSize(e.target.value)}>
                                {priceOptions.map((food) => (
                        ...
                        <hr></hr>
                        <button className='btn bg-secondary justify-center ms-2' onClick={handleAddToCart}> Add to Cart </button>
                    </div>
                </div>
            </div>
        </div>
